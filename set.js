...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~DqxlFLra#lNtQ2nRP1cWzgenaDZBuY6VgpM7vW2j3fbIo2UrV4XI", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "254791195553", // Only 1 owner Number Here, others Add to sudo numbers...
OWNER_NAME: process.env.OWNER_NAME || "Ray-bandit", // Input Yours custom...(Maintain font for Flow)
PACK_AUTHOR: process.env.PACK_AUTHOR || "Raybotto", // Added // Input Yours custom...
PACK_NAME: process.env.PACK_NAME || "RAyV7💜", // Added // Input Yours custom...
...
BOT_NAME: process.env.BOT_NAME || "RAY-V7", // Input Yours custom...(Maintain font for Flow)
